...
const registeredTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: '在 docker run 命令和 Docker Compose YAML 之间互相转换，并标出不可无损表达的字段。',
    path: '/tools/docker-run-compose',
    category: 'code',
    group: 'DevOps',
    keywords: ['docker', 'run', 'compose', 'container', 'devops', 'yaml', 'convert'],
    aliases: ['docker run compose', 'compose to docker run', 'docker run to compose', 'container run'],
    order: 15,
    status: 'active',
    privacy: 'local',
    component: () => import('./docker-run-compose/DockerRunComposeTool.vue'),
  },
  {
    id: 'kubernetes-yaml',
